...
/**
 * Response payload representing the farmer's full personal and farm profile.
 */
public class FarmerProfileResponse {
    ...
    public FarmerProfileResponse(Long userId, String fullName, String mobileNumber, String email,
                                 PreferredLanguage preferredLanguage, UserRole role,
